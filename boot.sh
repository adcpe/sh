...
echo "title     Arch Linux with Linux Kernel" >/boot/loader/entries/linux.conf
...
echo "options   root=/dev/sda2 rw" >>/boot/loader/entries/linux.conf

echo "title     Arch Linux with Linux LTS Kernel" >/boot/loader/entries/linux-lts.conf
...
echo "options   root=/dev/sda2 rw" >>/boot/loader/entries/linux-lts.conf
